...
class UploadNewsletters extends StatefulWidget {
  const UploadNewsletters({Key? key}) : super(key: key);

  @override
  State<UploadNewsletters> createState() => _UploadNewslettersState();
}

class _UploadNewslettersState extends State<UploadNewsletters> {
  File? image;
  ...
  void uploadImage() {
    adminServices.uploadNewsletters(context: context, image: image!);
  }
            ...
            : GestureDetector(
                ...
                child: DottedBorder(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: SizedBox(
                        height: DimensionsDesk.length10 * 13,
                        child: Image.asset(
                          'assets/images/uploadnewsletter.png',
                        ),
                      ),
                    ),
                  ),
